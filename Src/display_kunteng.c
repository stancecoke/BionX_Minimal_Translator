...
void display_update(MotorState_t* MS_U)
{
 ...
 // if (brake_is_set ()) { ui8_moving_indication |= (1 << 5); }
  ...
  ui32_battery_volts =  (MS_U->Voltage*CAL_BAT_V*256)/10000;  //hier noch die richtige Kalibrierung einbauen (*256 f¸r bessere Auflˆsung)
...
ui8_tx_buffer [0] = 65;
  ...
  ui8_tx_buffer [8] =  (uint8_t)(MS_U->Power);   //Kalibrierung muﬂ angepasst werden 13W pro digit
