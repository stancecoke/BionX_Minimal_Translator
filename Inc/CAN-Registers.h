...
#define DIS_ALIVE 495		// wird regelmäßig gesendet, beim Abschalten ändert sich Byte 0 von 128 auf 0, Rest bleibt immer gleich
#define CON_ALIVE 296		// wird nur zum Ende der Einschaltsequenz gesendet
#define DIS_ASSIST 552		// Byte0 ist die Unterstützungsstufe, wird erst nach der Einschaltprozedur gesendet
#define DIS_SPEED 751  		//? Speed x 10, Byte3 LSB, Byte4 MSB, Byte0 Assist Level, Byte2 Error ?!
#define CON_SPEED 1007L 		//? Speed x 10, Byte3 LSB, Byte4 MSB, Byte2 Error ?!
